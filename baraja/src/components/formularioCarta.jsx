...
const FormularioCarta = () =>{
    ...
    const handleSubmit=(e) =>{
      e.preventDefault()
      this.props.onAgregarCarta(state)
        ...
        <div>
            <div className= "card">
                <form className= "card-body" onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                         <input value={state.numero} onChange={(evt) => handleInput(evt)} type= "text" name= "numero" className="form-control" placeholder="Número"/>
                    </div>
                    <div className="form-group">
                         <input value={state.valor} onChange={(evt) => handleInput(evt)} type= "number" name= "valor" className="form-control" placeholder="Valor"/>
                    </div>
